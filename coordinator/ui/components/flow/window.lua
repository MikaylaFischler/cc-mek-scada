...
return function (parent, width, height, title, close_cb)
    ...
    TextBox{parent=root,height=1,text=string.rep("\x8f",width-3),fg_bg=cpair(parent.get_fg_bg().bkg,colors.gray)}
    TextBox{parent=root,y=2,text=" "..title,fg_bg=cpair(colors.white,colors.gray)}
    ...
    local window = Rectangle{parent=root,y=3,border=border(1,colors.gray,true)}
