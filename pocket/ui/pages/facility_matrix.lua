...
return function (app, panes, matrix_pane, ps, update)
    ...
    local fill = DataIndicator{parent=mtx_ext_div,x=14,y=6,lu_colors=lu_col,unit="%",format="%6.2f",value=0,width=8,fg_bg=text_fg}
    ...
    local in_util = DataIndicator{parent=mtx_ext_div,x=14,y=10,lu_colors=lu_col,unit="%",format="%6.2f",value=0,width=8,fg_bg=text_fg}
    TextBox{parent=mtx_ext_div,text="Output Util.",y=11,width=13,fg_bg=label}
    local out_util = DataIndicator{parent=mtx_ext_div,x=14,y=11,lu_colors=lu_col,unit="%",format="%6.2f",value=0,width=8,fg_bg=text_fg}
    ...
    local capacity  = DataIndicator{parent=mtx_ext_div,y=14,lu_colors=lu_col,unit="",format="%21d",value=0,width=21,fg_bg=text_fg}
    TextBox{parent=mtx_ext_div,text="Max In/Out ("..db.energy_label.."/t)",y=15,fg_bg=label}
    local trans_cap = DataIndicator{parent=mtx_ext_div,y=16,lu_colors=lu_col,unit="",format="%21d",rate=true,value=0,width=21,fg_bg=text_fg}
