...
doc("fp_crd_mon_flow", "FLOW DISPLAY", "The status of the coolant and waste flow display monitor (same LED states as MAIN DISPLAY).")
doc("fp_crd_mon_unit", "UNIT X DISPLAY", "The status of the monitor associated with a given unit (same LED states as MAIN DISPLAY).")
sect("API Tab")
