...
doc("as_ess_fault", "Energy Storage Fault", "Automatic SCRAM occurred due to the loss of the energy storage connection, or it being unformed or faulted.")
doc("as_ess_fill", "Energy Storage Charge High", "Automatic SCRAM occurred due to energy storage charge exceeding acceptable limit.")
