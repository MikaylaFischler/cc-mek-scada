...
function plc.comms(version, nic, reactor, rps, conn_watchdog)
    ...
    ---@return rplc_dataframe|mgmt_dataframe|nil packet
    ...
    ---@param packet rplc_dataframe|mgmt_dataframe packet frame
